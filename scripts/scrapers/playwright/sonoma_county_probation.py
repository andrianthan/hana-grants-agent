"""Sonoma County Probation Department scraper.

Scrapes https://sonomacounty.ca.gov/probation for county probation
RFPs and contracts relevant to Hanna's referral programs.
"""
    ...
    async def _scrape_page(self, page: Page) -> list[RawGrant]:
        ...
        for item in items:
            ...
            grants.append(RawGrant(
                title=title,
                funder="Sonoma County Probation",
                description=desc,
                deadline=deadline,
            ...
            if main:
                ...
                for link in links:
                    ...
                    if title and len(title) >= 10 and (
                        ...
                        or "grant" in title.lower() or "solicitation" in title.lower()
                    ):
                        grants.append(RawGrant(
                            title=title,
                            funder="Sonoma County Probation",
        ...
        logger.info(f"sonoma_county_probation: found {len(grants)} opportunities")
        return grants
