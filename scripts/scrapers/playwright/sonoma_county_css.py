"""Sonoma County Community Services and Support scraper.

Scrapes https://sonomacounty.ca.gov/css for county community services
RFPs for recreation, enrichment, and youth development programs.
"""
    ...
    async def _scrape_page(self, page: Page) -> list[RawGrant]:
        ...
        for item in items:
            ...
            grants.append(RawGrant(
                title=title,
                funder="Sonoma County Community Services",
                description=desc,
                deadline=deadline,
            ...
            if main:
                ...
                for link in links:
                    ...
                    if title and len(title) >= 10 and (
                        "rfp" in title.lower() or "grant" in title.lower()
        ...
        logger.info(f"sonoma_county_css: found {len(grants)} opportunities")
        return grants
